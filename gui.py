...
class PasswordManagerGUI:
    ...
    def create_login_frame(self):
        ...
        self.username_label = ctk.CTkLabel(
            self.login_frame, font=self.font_index, text="Username:"
        )
        self.username_label.grid(column=0, row=0, padx=(20, 5), pady=(20, 5))
        self.username_entry = ctk.CTkEntry(
            self.login_frame, font=self.font_entry, corner_radius=10, height=35
        )
        self.username_entry.grid(row=0, column=1, padx=(5, 20), pady=(20, 5))

        self.password_label = ctk.CTkLabel(
            self.login_frame, text="Password:", font=self.font_index
        )
    ...
    def create_register_frame(self):
        ...
        self.username_reg_label = ctk.CTkLabel(
            self.register_frame, text="Username:", font=self.font_index
        )
        self.username_reg_label.grid(row=0, column=0, padx=(20, 5), pady=(20, 5))
        self.username_reg_entry = ctk.CTkEntry(
            self.register_frame, font=self.font_entry
        )
        self.username_reg_entry.grid(row=0, column=1, padx=(5, 20), pady=(20, 5))

        self.password_reg_label = ctk.CTkLabel(
            self.register_frame, text="Password:", font=self.font_index
        )
        self.password_reg_label.grid(row=1, column=0, padx=(20, 5), pady=5)
        self.password_reg_entry = ctk.CTkEntry(
            self.register_frame, show="*", font=self.font_entry
        )
        self.password_reg_entry.grid(row=1, column=1, padx=(5, 20), pady=5)

        self.repassword_reg_label = ctk.CTkLabel(
            self.register_frame, text="Re-Enter Password:", font=self.font_index
        )
        self.repassword_reg_label.grid(row=2, column=0, padx=(20, 5), pady=5)
        self.repassword_reg_entry = ctk.CTkEntry(
            self.register_frame, show="*", font=self.font_entry
        )
        ...
        self.error_reg_label = ctk.CTkLabel(
            self.register_frame, text="", font=self.font_error
        )
    ...
    def login(self):
        ...
        if login_status == "Login successful.":
            self.user = self.db.execute_query(
                "SELECT * FROM users WHERE user_id = ?", (self.auth.current_user,)
            )[0]
    ...
    def show_loading_screen(self):
        ...
        self.loading_label = ctk.CTkLabel(
            self.loading_frame, text="Loading, please wait...", font=("Roboto", 16)
        )
    ...
    def _create_dashboard_frames(self):
        ...
        self.tools_main_frame = ctk.CTkFrame(
            self.main_container, fg_color="gray15", width=200
        )
        self.pass_container_frame = ctk.CTkFrame(
            self.main_container,
            border_color=self.bcolor_container,
            border_width=self.width_container,
            fg_color="transparent",
            corner_radius=self.corrad_main_container,
        )
        self.passgen_container_frame = ctk.CTkFrame(
            self.main_container,
            border_color=self.bcolor_container,
            border_width=self.width_container,
            fg_color="transparent",
        ...
        self.outdata_container_frame = ctk.CTkFrame(
            self.main_container,
            border_color=self.bcolor_container,
            border_width=self.width_container,
            fg_color="transparent",
        ...
        self.indata_container_frame = ctk.CTkFrame(
            self.main_container,
            border_color=self.bcolor_container,
            border_width=self.width_container,
            fg_color="transparent",
        ...
        self.user_container_frame = ctk.CTkFrame(
            self.main_container,
            border_color=self.bcolor_container,
            border_width=self.width_container,
            fg_color="transparent",
        ...
        self.stats_container_frame = ctk.CTkFrame(
            self.main_container,
            border_color=self.bcolor_container,
            border_width=self.width_container,
            fg_color="transparent",
    ...
    def fill_tools_frame(self):
        ...
        self.tools_header_frame = ctk.CTkFrame(
            self.tools_main_frame, fg_color="transparent"
        )
        self.tools_header_frame.grid(
            row=0, column=0, padx=10, pady=(42, 50), sticky="nwe"
        )

        self.tools_header_frame.grid_columnconfigure(0, weight=1)

        self.tools_nav_frame = ctk.CTkFrame(
            self.tools_main_frame, fg_color="transparent"
        )
        ...
        self.tools_footer_frame = ctk.CTkFrame(
            self.tools_main_frame, fg_color="transparent"
        )
        ...
        self.welcome_label = ctk.CTkLabel(
            self.tools_header_frame, text="Welcome", font=self.font_title
        )
        self.welcome_label.grid(row=0, column=0, padx=10, pady=5, sticky="nsew")

        self.welcome_name_label = ctk.CTkLabel(
            self.tools_header_frame, text="", font=self.font_title
        )
        self.welcome_name_label.grid(row=1, column=0, padx=10, pady=5, sticky="nsew")

        self.change_welcome_label(self.user["username"])

        self.tools_header_separator = ctk.CTkFrame(
            self.tools_header_frame,
            height=self.width_separator,
            corner_radius=self.corrad_separator,
            fg_color=self.bcolor_separator,
        )
        ...
        self.passwords_button = ctk.CTkButton(
            ...
            text="Passwords",
            font=self.font_bigbutton,
            width=width,
            height=height,
            border_color=self.bcolor_tools_btn,
            border_width=1,
            command=lambda: self.selected_tools_button(self.passwords_button),
            corner_radius=self.corrad_tools,
            fg_color=self.color_tools_btn,
        )
        self.passwords_button.grid(row=0, column=0, padx=5, pady=20)

        self.pass_gen_button = ctk.CTkButton(
            self.tools_nav_frame,
            ...
            border_color=self.bcolor_tools_btn,
            border_width=1,
            command=lambda: self.selected_tools_button(self.pass_gen_button),
            corner_radius=self.corrad_tools,
        )
        ...
        self.import_data_button = ctk.CTkButton(
            ...
            border_color=self.bcolor_tools_btn,
            border_width=1,
            command=lambda: self.selected_tools_button(self.import_data_button),
            corner_radius=self.corrad_tools,
        )
        ...
        self.export_data_button = ctk.CTkButton(
            ...
            border_color=self.bcolor_tools_btn,
            border_width=1,
            command=lambda: self.selected_tools_button(self.export_data_button),
            corner_radius=self.corrad_tools,
        )
        ...
        self.statistics_button = ctk.CTkButton(
            ...
            border_color=self.bcolor_tools_btn,
            border_width=1,
            command=lambda: self.selected_tools_button(self.statistics_button),
            corner_radius=self.corrad_tools,
        )
        ...
        self.user_button = ctk.CTkButton(
            ...
            border_color=self.bcolor_tools_btn,
            border_width=1,
            command=lambda: self.selected_tools_button(self.user_button),
            corner_radius=self.corrad_tools,
        )
        ...
        self.logout_button = ctk.CTkButton(
            ...
            height=height,
            border_color="gray",
            hover_color=self.color_tools_btn_hover,
            font=self.font_bigbutton,
            command=self.logout,
            corner_radius=self.corrad_tools,
        )
        ...
        self.all_tools_buttons = [
            self.passwords_button,
            self.pass_gen_button,
    ...
    def selected_tools_button(self, clicked_button):
        ...
        clicked_button.configure(
            fg_color=self.color_tools_btn_selected
        )  # Highlight selected
    ...
    def fill_pass_frame(self):
        ...
        self.pass_left_frame = ctk.CTkFrame(
            self.pass_container_frame,
            border_color=self.bcolor_passContainer,
            border_width=2,
            fg_color="transparent",
            corner_radius=self.corrad_containers,
        )
        ...
        self.pass_left_frame_header = ctk.CTkFrame(
            self.pass_left_frame, fg_color="transparent"
        )
        self.pass_left_frame_header.grid(
            row=0, column=0, padx=5, pady=(40, 0), sticky="nsew"
        )

        self.pass_left_frame_label = ctk.CTkLabel(
            self.pass_left_frame_header, text="Choose password", font=self.font_title
        )
        self.pass_left_frame_label.grid(row=0, column=0, padx=5, pady=5, sticky="nsew")

        self.pass_left_frame_search = ctk.CTkEntry(
            self.pass_left_frame_header,
            font=self.font_entry,
        ...
        self.pass_left_frame_az = ctk.CTkButton(
            button_frame,
            text="A-Z",
            width=1,
            command=lambda: self.populate_password_buttons("az"),
        )
        self.pass_left_frame_az.grid(row=0, column=0, padx=5, pady=5, sticky="nsew")

        self.pass_left_frame_za = ctk.CTkButton(
            button_frame,
            text="Z-A",
            width=1,
            command=lambda: self.populate_password_buttons("za"),
        )
        ...
        self.pass_left_frame_footer = ctk.CTkFrame(
            self.pass_left_frame, fg_color="transparent"
        )
        self.pass_left_frame_footer.grid(
            row=2, column=0, padx=5, pady=20, sticky="nsew"
        )

        self.pass_left_frame_footer.grid_columnconfigure(0, weight=1)
        self.pass_left_frame_footer.grid_columnconfigure(1, weight=1)

        self.pass_left_frame_add = ctk.CTkButton(
            self.pass_left_frame_footer, text="Add", width=1, command=self.add_password
        )
        self.pass_left_frame_add.grid(row=0, column=0, padx=1, pady=5, sticky="nsew")

        self.pass_left_frame_delete = ctk.CTkButton(
            self.pass_left_frame_footer,
            text="Delete",
            width=1,
        ...
        self.pass_right_frame = ctk.CTkFrame(
            self.pass_container_frame,
            border_color=self.bcolor_passContainer,
            border_width=2,
            fg_color="transparent",
        ...
        self.pass_right_frame_header = ctk.CTkFrame(
            self.pass_right_frame, fg_color="transparent"
        )
        self.pass_right_frame_header.grid(
            row=0, column=0, padx=5, pady=(40, 10), sticky="nsew"
        )
        self.pass_right_frame_header.grid_columnconfigure(0, weight=1)

        self.pass_right_frame_header_label = ctk.CTkLabel(
            self.pass_right_frame_header, text="", font=self.font_title, anchor="w"
        )
        self.pass_right_frame_header_label.grid(
            row=0, column=0, padx=25, pady=5, sticky="w"
        )

        # Main for Passwords right frame

        self.pass_right_frame_main = ctk.CTkFrame(
            self.pass_right_frame, fg_color="transparent"
        )
    ...
    def passwords_dash(self):
        ...
        self.root.title(
            f"Password Manager - Dashboard - User: {self.user['username']} - Passwords"
        )
    ...
    def selected_passwords_button(self, clicked_name):
        if clicked_name in self.all_passwords_buttons.keys():
            ...
            self.selected_pass_btn.configure(
                fg_color=self.color_pass_name_selected
            )  # Highlight selected
    ...
    def add_password(self):
        ...
        x_offset, y_offset = self.center_new_window(
            new_window_width, new_window_height, self.root
        )
        self.add_pass_win.geometry(
            f"{new_window_width}x{new_window_height}+{x_offset}+{y_offset}"
        )
        ...
        name_label = ctk.CTkLabel(
            container_frame, text="* Name:", font=self.font_normal
        )
        ...
        website_label = ctk.CTkLabel(
            container_frame, text="Website:", font=self.font_normal
        )
        ...
        username_label = ctk.CTkLabel(
            container_frame, text="* Username:", font=self.font_normal
        )
        ...
        password_label = ctk.CTkLabel(
            container_frame, text="* Password:", font=self.font_normal
        )
        ...
        comment_label = ctk.CTkLabel(
            container_frame, text="Comment:", font=self.font_normal
        )
        ...
        help_label = ctk.CTkLabel(
            container_frame, text="Fields with * are required", font=self.font_help
        )
        help_label.grid(row=5, column=0, padx=5, pady=10, columnspan=2)

        submit_button = ctk.CTkButton(
            container_frame, text="Submit", font=self.font_button, command=submit_entry
        )
        ...
        if self.selected_pass_name:
            ...
            if response == "OK":
                entries = self.db.execute_query(
                    "SELECT * FROM passwords WHERE name = ?", (self.selected_pass_name,)
                )
                if entries:
    ...
    def get_pass_tab(self, name):
        ...
        self.pass_right_frame_header_separator = ctk.CTkFrame(
            self.pass_right_frame_header,
            height=self.width_separator,
            fg_color=self.bcolor_separator,
            corner_radius=self.corrad_separator,
        )
        self.pass_right_frame_header_separator.grid(
    ...
    def create_pass_tab_frame(self, name):
        ...
        def save_field(old_text, field_name, entry_widget, entry_id, help_label):
            ...
            if result in (
                ...
                entry_widget.after(
                    500, lambda: entry_widget.configure(fg_color="#343638")
                )
                pass
        ...
        for i, entry in enumerate(entries):
            ...
            help_label = ctk.CTkLabel(
                pass_entry_frame, text="", font=self.font_help_del
            )
            help_label.grid(
                row=len(fields), column=0, padx=5, pady=(5, 0), columnspan=5
            )

            for row, (label_text, field_key) in enumerate(fields):
                ctk.CTkLabel(
                    pass_entry_frame, text=f"{label_text}: ", font=self.font_dash
                ).grid(row=row, column=0, padx=5, pady=5)

                entry_widget = ctk.CTkEntry(
                    pass_entry_frame, font=self.font_entry, width=200
                )
                ...
                entry_widget.bind(
                    "<FocusOut>",
                    lambda e, eid=entry["entry_id"], fk=field_key: on_focus_out(
                        e, eid, fk
                    ),
                )
                ...
                save_btn = ctk.CTkButton(
                    ...
                    text="Save",
                    width=button_width,
                    command=lambda old=field_value, e=entry_widget, f=field_key, eid=entry[
                        "entry_id"
                    ], h=help_label: save_field(
                        old, f, e, eid, h
                    ),
                )
                ...
                copy_btn = ctk.CTkButton(
                    ...
                    text="Copy",
                    width=button_width,
                    command=lambda e=entry_widget, h=help_label: copy_to_clipboard(
                        e, h
                    ),
                )
                ...
                if field_key == "password":
                    toggle_btn = ctk.CTkButton(
                        pass_entry_frame, text="Show", width=button_width
                    )
                    toggle_btn.grid(row=row, column=4, padx=2, pady=5)
                    toggle_btn.configure(
                        command=lambda e=entry_widget, btn=toggle_btn, eid=entry[
                            "entry_id"
                        ]: toggle_password(e, btn, eid)
                    )
            ...
            ctk.CTkLabel(
                pass_entry_frame,
                text=f"Last modified: {date_label}",
                font=self.font_help,
            ).grid(row=len(fields) + 1, column=0, padx=5, pady=5, columnspan=5)
            ...
            delete_btn = ctk.CTkButton(
                ...
                fg_color="#BF573A",
                hover_color="#823232",
                command=lambda eid=entry["entry_id"], f=pass_entry_frame, n=entry[
                    "name"
                ]: delete_entry(eid, f, n),
            )
            ...
            separator_bottom.grid(
                row=len(fields) + 3, column=0, columnspan=5, sticky="ew", padx=5, pady=5
            )
    ...
    def populate_password_buttons(self, order=None):
        ...
        if order == "az":
            sorted_password_names = sorted(
                self.get_password_names(self.user_passwords), key=str.lower
            )
        elif order == "za":
            sorted_password_names = sorted(
                self.get_password_names(self.user_passwords),
                key=str.lower,
                reverse=True,
            )
        else:
    ...
    def clear_help_labels(self, frame):
        ...
        for widget in frame.winfo_children():
            if isinstance(widget, ctk.CTkFrame):
                ...
                and widget.cget("font") == self.font_help_del
            ):
    ...
    def pass_gen_dash(self):
        ...
        self.root.title(
            f"Password Manager - Dashboard - User: {self.user['username']} - Password Generator"
        )

        # Grid the password generator container
        self.passgen_container_frame.grid(
    ...
    def fill_pass_gen_frame(self):
        ...
        self.passgen_header_frame = ctk.CTkFrame(
            self.passgen_container_frame,
            fg_color="transparent",
        )
        self.passgen_header_frame.grid(
            row=0, column=0, padx=20, pady=(60, 20), sticky="new"
        )
        self.passgen_header_frame.grid_columnconfigure(0, weight=1)

        self.passgen_main_frame = ctk.CTkFrame(
            self.passgen_container_frame,
            fg_color="transparent",
        )
        self.passgen_main_frame.grid(
            row=1, column=0, padx=(40, 20), pady=20, sticky="nsew"
        )
        self.passgen_main_frame.columnconfigure(2, weight=1)

        self.passgen_title = ctk.CTkLabel(
            self.passgen_header_frame,
            text="Password Generator",
        ...
        self.passgen_header_separator = ctk.CTkFrame(
            self.passgen_header_frame,
            height=self.width_separator,
            fg_color=self.bcolor_separator,
            corner_radius=self.corrad_separator,
        )
        self.passgen_header_separator.grid(
            row=1, column=0, padx=15, pady=5, sticky="ew"
        )

        self.passgen_length_label = ctk.CTkLabel(
            self.passgen_main_frame, text="Length of password:", font=self.font_normal
        )
        self.passgen_length_label.grid(row=0, column=0, padx=5, pady=5, sticky="w")

        self.passgen_length_entry = ctk.CTkEntry(
            self.passgen_main_frame, font=self.font_entry, width=width
        )
        self.passgen_length_entry.grid(row=0, column=1, padx=5, pady=5, sticky="w")
        self.passgen_length_entry.insert(0, "12")

        self.passgen_digits_label = ctk.CTkLabel(
            self.passgen_main_frame, text="How many digits:", font=self.font_normal
        )
        self.passgen_digits_label.grid(row=1, column=0, padx=5, pady=5, sticky="w")

        self.passgen_digits_entry = ctk.CTkEntry(
            self.passgen_main_frame, font=self.font_entry, width=width
        )
        self.passgen_digits_entry.grid(row=1, column=1, padx=5, pady=5, sticky="w")
        self.passgen_digits_entry.insert(0, "2")

        self.passgen_symbols_label = ctk.CTkLabel(
            self.passgen_main_frame,
            text="How many special symbols (@, !, etc.):",
            font=self.font_normal,
        )
        self.passgen_symbols_label.grid(row=2, column=0, padx=5, pady=5, sticky="w")

        self.passgen_symbols_entry = ctk.CTkEntry(
            self.passgen_main_frame, font=self.font_entry, width=width
        )
        self.passgen_symbols_entry.grid(row=2, column=1, padx=5, pady=5, sticky="w")
        self.passgen_symbols_entry.insert(0, "2")

        self.passgen_word_label = ctk.CTkLabel(
            self.passgen_main_frame,
            text="Include word (e.g. 'john'):",
            font=self.font_normal,
        )
        self.passgen_word_label.grid(row=3, column=0, padx=5, pady=5, sticky="w")

        self.passgen_word_entry = ctk.CTkEntry(
            self.passgen_main_frame, font=self.font_entry, width=width
        )
        self.passgen_word_entry.grid(row=3, column=1, padx=5, pady=5, sticky="w")

        self.passgen_uppercase_checkbox = ctk.CTkCheckBox(
            self.passgen_main_frame,
            text="Include uppercase letters",
            font=self.font_normal,
        )
        self.passgen_uppercase_checkbox.grid(
            row=4, column=0, padx=5, pady=5, sticky="w"
        )
        self.passgen_uppercase_checkbox.select()

        self.passgen_generate_button = ctk.CTkButton(
            self.passgen_main_frame,
            text="Generate",
            font=self.font_std_button,
            command=self.generate_password,
        )
        self.passgen_generate_button.grid(row=5, column=0, padx=5, pady=5, sticky="w")

        self.passgen_result_help = ctk.CTkLabel(
            self.passgen_main_frame, text="", font=self.font_help
        )
        self.passgen_result_help.grid(
            row=6, column=0, columnspan=2, padx=5, pady=5, sticky="w"
        )

        self.passgen_result_label = ctk.CTkLabel(
            self.passgen_main_frame, text="Generated password:", font=self.font_normal
        )
        self.passgen_result_label.grid(row=1, column=2, padx=5, pady=5)

        self.passgen_result_entry = ctk.CTkEntry(
            self.passgen_main_frame, font=self.font_entry, width=200
        )
        self.passgen_result_entry.grid(row=2, column=2, padx=5, pady=5)

        self.passgen_result_copybtn = ctk.CTkButton(
            self.passgen_main_frame,
            text="Copy",
            font=self.font_std_button,
    ...
    def generate_password(self):
        ...
        if len(word) > length:
            self.passgen_result_help.configure(
                text="Word length exceeds required password length."
            )
            return

        if length < (digits + symbols + len(word)):
            self.passgen_result_help.configure(
                text="Length of password is too short for given settings."
            )
            return
    ...
    def copy_password(self):
        ...
        self.passgen_result_help.after(
            2000, lambda: self.passgen_result_help.configure(text="")
        )
    ...
    def import_data_dash(self):
        ...
        self.root.title(
            f"Password Manager - Dashboard - User: {self.user['username']} - Import Data"
        )

        # Grid the import data container
        self.indata_container_frame.grid(
            row=0, column=1, padx=20, pady=20, sticky="nsew"
        )
    ...
    def fill_import_data_frame(self):
        self.indata_header_frame = ctk.CTkFrame(
            self.indata_container_frame, fg_color="transparent"
        )
        self.indata_header_frame.grid(
            row=0, column=0, padx=20, pady=(60, 20), sticky="new"
        )
        self.indata_header_frame.grid_columnconfigure(0, weight=1)

        self.indata_main_frame = ctk.CTkFrame(
            self.indata_container_frame, fg_color="transparent"
        )
        self.indata_main_frame.grid(
            row=1, column=0, padx=(40, 20), pady=20, sticky="nsew"
        )

        self.indata_title_label = ctk.CTkLabel(
            self.indata_header_frame,
        ...
        self.indata_header_separator = ctk.CTkFrame(
            self.indata_header_frame,
            height=self.width_separator,
            fg_color=self.bcolor_separator,
            corner_radius=self.corrad_separator,
        ...
        self.indata_select_label = ctk.CTkLabel(
            self.indata_main_frame, text="Select file:", font=self.font_normal
        )
        self.indata_select_label.grid(row=0, column=0, padx=5, pady=5, sticky="w")

        self.indata_select_entry = ctk.CTkEntry(
            self.indata_main_frame, font=self.font_entry, width=300
        )
        self.indata_select_entry.grid(row=0, column=1, padx=5, pady=5, sticky="w")

        self.indata_select_button = ctk.CTkButton(
            self.indata_main_frame,
            text="Browse",
            font=self.font_std_button,
            width=1,
            command=self.browse_import_path,
        )
        self.indata_select_button.grid(row=0, column=2, padx=5, pady=5, sticky="w")

        self.indata_import_button = ctk.CTkButton(
            self.indata_main_frame,
            text="Import",
            font=self.font_std_button,
            command=self.import_data,
        )
        self.indata_import_button.grid(
            row=1, column=0, padx=5, pady=(15, 5), sticky="w"
        )

        self.indata_help_label = ctk.CTkLabel(
            self.indata_main_frame, text="", font=self.font_help
        )
        self.indata_help_label.grid(
        ...
        try:
            ...
            if imported_passwords > 0:
                ...
                if replicate_entries > 0:
                    self.indata_help_label.configure(
                        text=f"{imported_passwords} password(s) imported successfully. {replicate_entries} password(s) already exist."
                    )
                else:
                    self.indata_help_label.configure(
                        text=f"{imported_passwords} password(s) imported successfully."
                    )
            else:
    ...
    def export_data_dash(self):
        ...
        self.root.title(
            f"Password Manager - Dashboard - User: {self.user['username']} - Export Data"
        )

        # Grid the export data container
        self.outdata_container_frame.grid(
            row=0, column=1, padx=20, pady=20, sticky="nsew"
        )
    ...
    def fill_export_data_frame(self):
        self.outdata_header_frame = ctk.CTkFrame(
            self.outdata_container_frame, fg_color="transparent"
        )
        self.outdata_header_frame.grid(
            row=0, column=0, padx=20, pady=(60, 20), sticky="new"
        )
        self.outdata_header_frame.grid_columnconfigure(0, weight=1)

        self.outdata_main_frame = ctk.CTkFrame(
            self.outdata_container_frame, fg_color="transparent"
        )
        self.outdata_main_frame.grid(
            row=1, column=0, padx=(40, 20), pady=20, sticky="nsew"
        )

        self.outdata_title = ctk.CTkLabel(
            self.outdata_header_frame,
            text="Export Your Passwords",
            font=self.font_title,
            anchor="w",
        )
        self.outdata_title.grid(row=0, column=0, padx=25, pady=5, sticky="w")

        self.outdata_header_separator = ctk.CTkFrame(
            self.outdata_header_frame,
            height=self.width_separator,
            fg_color=self.bcolor_separator,
            corner_radius=self.corrad_separator,
        )
        self.outdata_header_separator.grid(
            row=1, column=0, padx=15, pady=5, sticky="ew"
        )

        self.outdata_select_label = ctk.CTkLabel(
            self.outdata_main_frame, text="Select destination:", font=self.font_normal
        )
        self.outdata_select_label.grid(row=0, column=0, padx=5, pady=5, sticky="w")

        self.outdata_select_entry = ctk.CTkEntry(
            self.outdata_main_frame, font=self.font_entry, width=300
        )
        self.outdata_select_entry.grid(row=0, column=1, padx=5, pady=5, sticky="w")

        self.outdata_select_button = ctk.CTkButton(
            self.outdata_main_frame,
            text="Browse",
            font=self.font_std_button,
            width=1,
        ...
        self.outdata_export_button = ctk.CTkButton(
            self.outdata_main_frame,
            text="Export",
            font=self.font_std_button,
            command=self.export_data,
        )
        self.outdata_export_button.grid(
            row=1, column=0, padx=5, pady=(15, 5), sticky="w"
        )

        self.outdata_help_label = ctk.CTkLabel(
            self.outdata_main_frame, text="", font=self.font_help
        )
        self.outdata_help_label.grid(
            row=2, column=0, columnspan=3, padx=5, pady=10, sticky="w"
        )
    ...
    def export_data(self):
        ...
        try:
            ...
            self.outdata_help_label.configure(
                text=f"{n_passwords} Passwords exported successfully."
            )
        except Exception as e:
    ...
    def statistics_dash(self):
        ...
        self.stats_container_frame.grid(
            row=0, column=1, padx=20, pady=20, sticky="nsew"
        )
    ...
    def fill_statistics_frame(self):
        self.stats_header_frame = ctk.CTkFrame(
            self.stats_container_frame, fg_color="transparent"
        )
        self.stats_header_frame.grid(
            row=0, column=0, padx=20, pady=(60, 20), sticky="new"
        )
        ...
        self.stats_main_frame.grid(
            row=1, column=0, padx=(40, 20), pady=20, sticky="nsew"
        )

        self.stats_title = ctk.CTkLabel(
            self.stats_header_frame, text="Statistics", font=self.font_title, anchor="w"
        )
        self.stats_title.grid(row=0, column=0, padx=25, pady=5, sticky="w")

        self.stats_header_separator = ctk.CTkFrame(
        ...
        self.stats_totalpass_label = ctk.CTkLabel(
            self.stats_main_frame, text="Total passwords:", font=self.font_normal
        )
        self.stats_totalpass_label.grid(row=0, column=0, padx=5, pady=5, sticky="w")

        self.stats_totalpass_label2 = ctk.CTkLabel(
            self.stats_main_frame,
            text=str(len(self.get_user_passwords(self.user["user_id"]))),
            font=self.font_normal,
        )
        self.stats_totalpass_label2.grid(row=0, column=1, padx=5, pady=5, sticky="w")

        self.stats_popular_label = ctk.CTkLabel(
            self.stats_main_frame, text="Most popular password:", font=self.font_normal
        )
        self.stats_popular_label.grid(row=1, column=0, padx=5, pady=5, sticky="w")

        self.stats_popular_label2 = ctk.CTkLabel(
            self.stats_main_frame,
            text=self.most_popular_password(),
            font=self.font_normal,
        )
    ...
    def user_dash(self):
        ...
        self.root.title(
            f"Password Manager - Dashboard - User: {self.user['username']} - Settings"
        )
    ...
    def fill_user_frame(self):
        self.user_header_frame = ctk.CTkFrame(
            self.user_container_frame, fg_color="transparent"
        )
        ...
        self.user_main_frame = ctk.CTkFrame(
            self.user_container_frame, fg_color="transparent"
        )
        self.user_main_frame.grid(
            row=1, column=0, padx=(40, 20), pady=20, sticky="nsew"
        )
        ...
        self.user_header_separator = ctk.CTkFrame(
            self.user_header_frame,
            height=self.width_separator,
            fg_color=self.bcolor_separator,
            corner_radius=self.corrad_separator,
        ...
        self.user_username_label = ctk.CTkLabel(
            self.user_main_frame, text="Current username:", font=self.font_normal
        )
        self.user_username_label.grid(row=0, column=0, padx=5, pady=5, sticky="w")

        self.user_username_label2 = ctk.CTkLabel(
            self.user_main_frame, text=self.user["username"], font=self.font_normal
        )
        self.user_username_label2.grid(row=0, column=1, padx=5, pady=5, sticky="w")

        self.user_newusername_label = ctk.CTkLabel(
            self.user_main_frame, text="New username:", font=self.font_normal
        )
        self.user_newusername_label.grid(row=1, column=0, padx=5, pady=5, sticky="w")

        self.user_newusername_entry = ctk.CTkEntry(
            self.user_main_frame, font=self.font_entry
        )
        self.user_newusername_entry.grid(row=1, column=1, padx=5, pady=5, sticky="w")

        self.user_newusername_button = ctk.CTkButton(
            self.user_main_frame,
            text="Change",
            font=self.font_std_button,
            command=lambda: self.update_username(
                username=self.user_newusername_entry.get()
            ),
        )
        self.user_newusername_button.grid(row=2, column=0, padx=5, pady=5, sticky="w")

        self.user_newusername_help_label = ctk.CTkLabel(
            self.user_main_frame, text="", font=self.font_help
        )
        self.user_newusername_help_label.grid(
            row=3, column=0, columnspan=2, padx=5, pady=5, sticky="w"
        )

        self.user_cuurentpass_label = ctk.CTkLabel(
            self.user_main_frame, text="Enter current password:", font=self.font_normal
        )
        self.user_cuurentpass_label.grid(
            row=4, column=0, padx=5, pady=(20, 5), sticky="w"
        )

        self.user_currentpass_entry = ctk.CTkEntry(
            self.user_main_frame, font=self.font_entry, show="*"
        )
        self.user_currentpass_entry.grid(
            row=4, column=1, padx=5, pady=(15, 5), sticky="w"
        )

        self.user_newpass_label = ctk.CTkLabel(
            self.user_main_frame, text="Enter new password:", font=self.font_normal
        )
        self.user_newpass_label.grid(row=5, column=0, padx=5, pady=5, sticky="w")

        self.user_newpass_entry = ctk.CTkEntry(
            self.user_main_frame, font=self.font_entry, show="*"
        )
        self.user_newpass_entry.grid(row=5, column=1, padx=5, pady=5, sticky="w")

        self.user_renewpass_label = ctk.CTkLabel(
            self.user_main_frame, text="Re-enter new password:", font=self.font_normal
        )
        self.user_renewpass_label.grid(row=6, column=0, padx=5, pady=5, sticky="w")

        self.user_renewpass_entry = ctk.CTkEntry(
            self.user_main_frame, font=self.font_entry, show="*"
        )
        self.user_renewpass_entry.grid(row=6, column=1, padx=5, pady=5, sticky="w")

        self.user_newpass_button = ctk.CTkButton(
            self.user_main_frame,
            text="Change",
            font=self.font_std_button,
            command=lambda: self.update_password(
                current_password=self.user_currentpass_entry.get(),
        ...
        self.user_newpass_help_label = ctk.CTkLabel(
            self.user_main_frame, text="", font=self.font_help
        )
        self.user_newpass_help_label.grid(
    ...
    def update_password(self, current_password, password, repassword):
        ...
        if current_password != self.pwman.user_password:
            self.user_newpass_help_label.configure(
